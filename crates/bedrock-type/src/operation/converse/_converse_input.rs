...
impl ConverseInput {
    ...
    /// [`ConverseInput`](crate::operation::converse::ConverseInput).
    pub fn builder(
    ) -> crate::operation::converse::builders::ConverseInputBuilder {
...
#[derive(
    ::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, Debug,
)]
#[non_exhaustive]
pub struct ConverseInputBuilder {
    ...
    pub(crate) system: ::std::option::Option<
        ::std::vec::Vec<crate::types::SystemContentBlock>,
    >,
    pub(crate) inference_config:
        ::std::option::Option<crate::types::InferenceConfiguration>,
    pub(crate) tool_config:
        ::std::option::Option<crate::types::ToolConfiguration>,
    pub(crate) guardrail_config:
        ::std::option::Option<crate::types::GuardrailConfiguration>,
...
impl ConverseInputBuilder {
    ...
    pub fn additional_model_request_fields(
        mut self,
        input: aws_smithy_types::Document,
    ) -> Self {
        self.additional_model_request_fields =
    ...
    ///
    /// To override the contents of this collection use
    /// [`set_prompt_variables`](Self::set_prompt_variables).
    ///
    /// <p>Contains a map of variables in a prompt from Prompt management to
    /// objects containing the values to fill in for them when running model
    /// invocation. This field is ignored if you don't specify a prompt resource
    ...
    ///
    /// To override the contents of this collection use
    /// [`set_additional_model_response_field_paths`](Self::set_additional_model_response_field_paths).
    ///
    ///
    /// <p>Additional model parameters field paths to return in the response.
    /// <code>Converse</code> and <code>ConverseStream</code> return the
    ...
    ///
    /// To override the contents of this collection use
    /// [`set_request_metadata`](Self::set_request_metadata).
    ///
    /// <p>Key-value pairs that you can use to filter invocation logs.</p>
    pub fn request_metadata(
        mut self,
