...
impl MessageStopEvent {
    ...
    /// [`MessageStopEvent`](crate::types::MessageStopEvent).
...
impl MessageStopEventBuilder {
    ...
    pub fn get_stop_reason(
        &self,
    ) -> &::std::option::Option<crate::types::StopReason> {
        &self.stop_reason
    }
    /// <p>The additional model response fields.</p>
    pub fn additional_model_response_fields(
    ...
    /// [`MessageStopEvent`](crate::types::MessageStopEvent). This method
        ...
        ::std::result::Result::Ok(crate::types::MessageStopEvent {
            stop_reason: self.stop_reason.ok_or_else(|| {
                aws_smithy_types::error::operation::BuildError::missing_field(
                    "stop_reason",
                    "stop_reason was not specified but it is required when \
                     building MessageStopEvent",
                )
            })?,
            additional_model_response_fields: self
