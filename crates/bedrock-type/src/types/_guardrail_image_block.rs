...
impl GuardrailImageBlock {
    ...
    pub fn source(
        &self,
    ) -> ::std::option::Option<&crate::types::GuardrailImageSource> {
        self.source.as_ref()
    }
}
...
impl GuardrailImageBlock {
    ...
    /// [`GuardrailImageBlock`](crate::types::GuardrailImageBlock).
...
pub struct GuardrailImageBlockBuilder {
    pub(crate) format:
        ::std::option::Option<crate::types::GuardrailImageFormat>,
    pub(crate) source:
        ::std::option::Option<crate::types::GuardrailImageSource>,
}
