...
/// <code>ConverseStream</code> action.</p>
#[non_exhaustive]
#[derive(
    ::std::clone::Clone,
    ::std::cmp::PartialEq,
...
pub struct GuardrailStreamConfiguration {
    ...
    /// <p>The processing mode. For more information, see <i>Configure
    /// streaming response behavior</i> in the <i>Amazon Bedrock User
    /// Guide</i>.</p>
...
impl GuardrailStreamConfiguration {
    ...
    /// <p>The processing mode.</p>
    /// <p>The processing mode. For more information, see <i>Configure streaming
    /// response behavior</i> in the <i>Amazon Bedrock User Guide</i>.</p>
    pub fn stream_processing_mode(
        &self,
    ) -> &crate::types::GuardrailStreamProcessingMode {
