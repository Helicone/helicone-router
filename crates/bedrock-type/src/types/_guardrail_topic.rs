...
pub struct GuardrailTopic {
    ...
    /// <p>The type behavior that the guardrail should perform when the model
    /// detects the topic.</p>
    pub r#type: crate::types::GuardrailTopicType,
    /// <p>The action the guardrail should take when it intervenes on a
    /// topic.</p>
    pub action: crate::types::GuardrailTopicPolicyAction,
    /// <p>Indicates whether topic content that breaches the guardrail
...
impl GuardrailTopic {
    ...
    /// [`GuardrailTopic`](crate::types::GuardrailTopic).
...
pub struct GuardrailTopicBuilder {
    ...
    pub(crate) action:
        ::std::option::Option<crate::types::GuardrailTopicPolicyAction>,
...
impl GuardrailTopicBuilder {
    ...
    /// <p>The type behavior that the guardrail should perform when the model
    /// detects the topic.</p> This field is required.
    ...
    pub fn get_type(
        &self,
    ) -> &::std::option::Option<crate::types::GuardrailTopicType> {
        &self.r#type
    }
    /// <p>The action the guardrail should take when it intervenes on a
    /// topic.</p> This field is required.
    pub fn action(
        mut self,
        input: crate::types::GuardrailTopicPolicyAction,
    ) -> Self {
    ...
    /// [`GuardrailTopic`](crate::types::GuardrailTopic). This method will
