...
pub enum ContentBlock {
    ...
    /// specify <code>guardContent</code> in a call to the Converse API, the
    /// guardrail (if passed in the Converse API) assesses the entire
    /// message.</p> <p>For more information, see <i>Use a guardrail with
    /// the Converse API</i> in the <i>Amazon Bedrock User Guide</i>.</p>
    ...
    /// <p>Contains content regarding the reasoning that is carried out by the
    /// model. Reasoning refers to a Chain of Thought (CoT) that the model
    /// generates to enhance the accuracy of its final response.</p>
...
impl ContentBlock {
    ...
    /// [`CachePoint`](crate::types::ContentBlock::CachePoint), extracting the
    /// inner [`CachePointBlock`](crate::types::CachePointBlock).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_cache_point(
        &self,
    ) -> ::std::result::Result<&crate::types::CachePointBlock, &Self> {
    ...
    /// [`CachePoint`](crate::types::ContentBlock::CachePoint).
    pub fn is_cache_point(&self) -> bool {
        self.as_cache_point().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`Document`](crate::types::ContentBlock::Document), extracting the inner
    /// [`DocumentBlock`](crate::types::DocumentBlock). Returns `Err(&Self)`
    /// if it can't be converted.
    pub fn as_document(
        &self,
    ) -> ::std::result::Result<&crate::types::DocumentBlock, &Self> {
    ...
    /// Returns true if this is a
    /// [`Document`](crate::types::ContentBlock::Document).
    pub fn is_document(&self) -> bool {
        self.as_document().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`GuardContent`](crate::types::ContentBlock::GuardContent), extracting
    /// the inner [`GuardrailConverseContentBlock`](crate::types::GuardrailConverseContentBlock).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_guard_content(
        &self,
    ) -> ::std::result::Result<
        &crate::types::GuardrailConverseContentBlock,
        &Self,
    > {
    ...
    /// Returns true if this is a
    /// [`GuardContent`](crate::types::ContentBlock::GuardContent).
    pub fn is_guard_content(&self) -> bool {
        self.as_guard_content().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`Image`](crate::types::ContentBlock::Image), extracting the inner
    /// [`ImageBlock`](crate::types::ImageBlock). Returns `Err(&Self)` if it
    /// can't be converted.
    pub fn as_image(
        &self,
    ) -> ::std::result::Result<&crate::types::ImageBlock, &Self> {
    ...
    /// Tries to convert the enum instance into
    /// [`ReasoningContent`](crate::types::ContentBlock::ReasoningContent),
    /// extracting the inner
    /// [`ReasoningContentBlock`](crate::types::ReasoningContentBlock).
    /// Returns `Err(&Self)` if it can't be converted.
    ...
    /// Tries to convert the enum instance into
    /// [`Text`](crate::types::ContentBlock::Text), extracting the inner
    /// [`String`](::std::string::String). Returns `Err(&Self)` if it can't
    /// be converted.
    pub fn as_text(
        &self,
    ...
    /// Tries to convert the enum instance into
    /// [`ToolResult`](crate::types::ContentBlock::ToolResult), extracting the
    /// inner [`ToolResultBlock`](crate::types::ToolResultBlock).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool_result(
        &self,
    ) -> ::std::result::Result<&crate::types::ToolResultBlock, &Self> {
    ...
    /// Returns true if this is a
    /// [`ToolResult`](crate::types::ContentBlock::ToolResult).
    pub fn is_tool_result(&self) -> bool {
        self.as_tool_result().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`ToolUse`](crate::types::ContentBlock::ToolUse), extracting the inner
    /// [`ToolUseBlock`](crate::types::ToolUseBlock). Returns `Err(&Self)`
    /// if it can't be converted.
    pub fn as_tool_use(
        &self,
    ) -> ::std::result::Result<&crate::types::ToolUseBlock, &Self> {
    ...
    /// Returns true if this is a
    /// [`ToolUse`](crate::types::ContentBlock::ToolUse).
    pub fn is_tool_use(&self) -> bool {
        self.as_tool_use().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`Video`](crate::types::ContentBlock::Video), extracting the inner
    /// [`VideoBlock`](crate::types::VideoBlock). Returns `Err(&Self)` if it
    /// can't be converted.
    pub fn as_video(
        &self,
    ) -> ::std::result::Result<&crate::types::VideoBlock, &Self> {
...
impl ::std::fmt::Debug for ContentBlock {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ContentBlock::CachePoint(val) => {
                f.debug_tuple("CachePoint").field(&val).finish()
            }
            ContentBlock::Document(val) => {
                f.debug_tuple("Document").field(&val).finish()
            }
            ContentBlock::GuardContent(val) => {
                f.debug_tuple("GuardContent").field(&val).finish()
            }
            ContentBlock::Image(val) => {
                f.debug_tuple("Image").field(&val).finish()
            }
            ContentBlock::ReasoningContent(_) => {
                f.debug_tuple("*** Sensitive Data Redacted ***").finish()
            }
            ContentBlock::Text(val) => {
                f.debug_tuple("Text").field(&val).finish()
            }
            ContentBlock::ToolResult(val) => {
                f.debug_tuple("ToolResult").field(&val).finish()
            }
            ContentBlock::ToolUse(val) => {
                f.debug_tuple("ToolUse").field(&val).finish()
            }
            ContentBlock::Video(val) => {
                f.debug_tuple("Video").field(&val).finish()
            }
