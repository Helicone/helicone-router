...
pub struct GuardrailContextualGroundingFilter {
    ...
    /// <p>The threshold used by contextual grounding filter to determine
    /// whether the content is grounded or not.</p>
    pub threshold: f64,
    /// <p>The score generated by contextual grounding filter.</p>
    pub score: f64,
    /// <p>The action performed by the guardrails contextual grounding
    /// filter.</p>
    pub action: crate::types::GuardrailContextualGroundingPolicyAction,
    /// <p>Indicates whether content that fails the contextual grounding
    /// evaluation (grounding or relevance score less than the corresponding
    /// threshold) was detected.</p>
...
impl GuardrailContextualGroundingFilter {
    ...
    pub fn r#type(
        &self,
    ) -> &crate::types::GuardrailContextualGroundingFilterType {
        &self.r#type
    }
    /// <p>The threshold used by contextual grounding filter to determine
    /// whether the content is grounded or not.</p>
    ...
    pub fn action(
        &self,
    ) -> &crate::types::GuardrailContextualGroundingPolicyAction {
        &self.action
    }
    /// <p>Indicates whether content that fails the contextual grounding
    /// evaluation (grounding or relevance score less than the corresponding
...
pub struct GuardrailContextualGroundingFilterBuilder {
    ...
    pub(crate) action: ::std::option::Option<
        crate::types::GuardrailContextualGroundingPolicyAction,
    >,
...
impl GuardrailContextualGroundingFilterBuilder {
    ...
    pub fn r#type(
        mut self,
        input: crate::types::GuardrailContextualGroundingFilterType,
    ) -> Self {
    ...
    /// <p>The threshold used by contextual grounding filter to determine
    /// whether the content is grounded or not.</p> This field is required.
    ...
    /// <p>The action performed by the guardrails contextual grounding
    /// filter.</p> This field is required.
    pub fn action(
        mut self,
        input: crate::types::GuardrailContextualGroundingPolicyAction,
    ) -> Self {
