...
pub enum GuardrailConverseContentBlock {
    /// <p>Image within converse content block to be evaluated by the
    /// guardrail.</p>
...
impl GuardrailConverseContentBlock {
    ...
    /// [`Image`](crate::types::GuardrailConverseContentBlock::Image),
    ...
    /// Tries to convert the enum instance into
    /// [`Text`](crate::types::GuardrailConverseContentBlock::Text), extracting
    /// the inner [`GuardrailConverseTextBlock`](crate::types::GuardrailConverseTextBlock).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_text(
        &self,
    ...
    /// Returns true if this is a
    /// [`Text`](crate::types::GuardrailConverseContentBlock::Text).
...
impl ::std::fmt::Debug for GuardrailConverseContentBlock {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            GuardrailConverseContentBlock::Text(val) => {
                f.debug_tuple("Text").field(&val).finish()
            }
            GuardrailConverseContentBlock::Unknown => {
