...
pub struct GuardrailAssessment {
    ...
    pub sensitive_information_policy: ::std::option::Option<
        crate::types::GuardrailSensitiveInformationPolicyAssessment,
    >,
    /// <p>The contextual grounding policy used for the guardrail
    /// assessment.</p>
    pub contextual_grounding_policy: ::std::option::Option<
        crate::types::GuardrailContextualGroundingPolicyAssessment,
    >,
    /// <p>The invocation metrics for the guardrail assessment.</p>
    pub invocation_metrics:
...
impl GuardrailAssessment {
    ...
    /// [`GuardrailAssessment`](crate::types::GuardrailAssessment).
...
pub struct GuardrailAssessmentBuilder {
    pub(crate) topic_policy:
        ::std::option::Option<crate::types::GuardrailTopicPolicyAssessment>,
    pub(crate) content_policy:
        ::std::option::Option<crate::types::GuardrailContentPolicyAssessment>,
    pub(crate) word_policy:
        ::std::option::Option<crate::types::GuardrailWordPolicyAssessment>,
    pub(crate) sensitive_information_policy: ::std::option::Option<
        crate::types::GuardrailSensitiveInformationPolicyAssessment,
    >,
    pub(crate) contextual_grounding_policy: ::std::option::Option<
        crate::types::GuardrailContextualGroundingPolicyAssessment,
    >,
    pub(crate) invocation_metrics:
        ::std::option::Option<crate::types::GuardrailInvocationMetrics>,
}
impl GuardrailAssessmentBuilder {
    ...
    pub fn topic_policy(
        mut self,
        input: crate::types::GuardrailTopicPolicyAssessment,
    ) -> Self {
    ...
    pub fn content_policy(
        mut self,
        input: crate::types::GuardrailContentPolicyAssessment,
    ) -> Self {
    ...
    pub fn word_policy(
        mut self,
        input: crate::types::GuardrailWordPolicyAssessment,
    ) -> Self {
    ...
    pub fn invocation_metrics(
        mut self,
        input: crate::types::GuardrailInvocationMetrics,
    ) -> Self {
