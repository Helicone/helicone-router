...
impl ContentBlockDelta {
    ...
    /// [`ReasoningContent`](crate::types::ContentBlockDelta::ReasoningContent),
    /// extracting the inner
    /// [`ReasoningContentBlockDelta`](crate::types::ReasoningContentBlockDelta).
    ...
    /// Tries to convert the enum instance into
    /// [`Text`](crate::types::ContentBlockDelta::Text), extracting the inner
    ...
    /// Returns true if this is a
    /// [`Text`](crate::types::ContentBlockDelta::Text).
    pub fn is_text(&self) -> bool {
        self.as_text().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`ToolUse`](crate::types::ContentBlockDelta::ToolUse), extracting the
    /// inner [`ToolUseBlockDelta`](crate::types::ToolUseBlockDelta).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool_use(
        &self,
    ) -> ::std::result::Result<&crate::types::ToolUseBlockDelta, &Self> {
    ...
    /// Returns true if this is a
    /// [`ToolUse`](crate::types::ContentBlockDelta::ToolUse).
...
impl ::std::fmt::Debug for ContentBlockDelta {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            ContentBlockDelta::Text(val) => {
                f.debug_tuple("Text").field(&val).finish()
            }
            ContentBlockDelta::ToolUse(val) => {
