...
impl TokenUsageBuilder {
    ...
    /// <p>The number of input tokens read from the cache for the request.</p>
    pub fn set_cache_read_input_tokens(
        mut self,
        input: ::std::option::Option<i32>,
    ) -> Self {
    ...
    /// <p>The number of input tokens written to the cache for the request.</p>
    pub fn set_cache_write_input_tokens(
        mut self,
        input: ::std::option::Option<i32>,
    ) -> Self {
    ...
    /// [`TokenUsage`](crate::types::TokenUsage). This method will fail if
        ...
        ::std::result::Result::Ok(crate::types::TokenUsage {
            input_tokens: self.input_tokens.ok_or_else(|| {
                aws_smithy_types::error::operation::BuildError::missing_field(
                    "input_tokens",
                    "input_tokens was not specified but it is required when \
                     building TokenUsage",
                )
            })?,
            output_tokens: self.output_tokens.ok_or_else(|| {
                aws_smithy_types::error::operation::BuildError::missing_field(
                    "output_tokens",
                    "output_tokens was not specified but it is required when \
                     building TokenUsage",
                )
            })?,
            total_tokens: self.total_tokens.ok_or_else(|| {
                aws_smithy_types::error::operation::BuildError::missing_field(
                    "total_tokens",
                    "total_tokens was not specified but it is required when \
                     building TokenUsage",
                )
            })?,
