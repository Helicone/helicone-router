...
/// <p>The model must request a specific tool. For example, <code>{"tool" :
/// {"name" : "Your tool name"}}</code>.</p><note> <p>This field is only
/// supported by Anthropic Claude 3 models.</p> </note>
#[non_exhaustive]
#[derive(
    ::std::clone::Clone,
    ::std::cmp::PartialEq,
