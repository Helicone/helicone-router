...
impl ToolResultBlock {
    ...
    pub fn status(
        &self,
    ) -> ::std::option::Option<&crate::types::ToolResultStatus> {
        self.status.as_ref()
    }
}
impl ToolResultBlock {
    /// Creates a new builder-style object to manufacture
    /// [`ToolResultBlock`](crate::types::ToolResultBlock).
...
pub struct ToolResultBlockBuilder {
    ...
    pub(crate) content: ::std::option::Option<
        ::std::vec::Vec<crate::types::ToolResultContentBlock>,
    >,
...
impl ToolResultBlockBuilder {
    ...
    /// [`ToolResultBlock`](crate::types::ToolResultBlock). This method will
