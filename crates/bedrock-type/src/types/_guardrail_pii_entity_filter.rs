...
pub struct GuardrailPiiEntityFilter {
    ...
    /// <p>Indicates whether personally identifiable information (PII) that
    /// breaches the guardrail configuration is detected.</p>
...
impl GuardrailPiiEntityFilter {
    ...
    pub fn action(
        &self,
    ) -> &crate::types::GuardrailSensitiveInformationPolicyAction {
        &self.action
    }
    /// <p>Indicates whether personally identifiable information (PII) that
    /// breaches the guardrail configuration is detected.</p>
...
impl GuardrailPiiEntityFilter {
    ...
    /// [`GuardrailPiiEntityFilter`](crate::types::GuardrailPiiEntityFilter).
...
pub struct GuardrailPiiEntityFilterBuilder {
    ...
    pub(crate) r#type:
        ::std::option::Option<crate::types::GuardrailPiiEntityType>,
...
impl GuardrailPiiEntityFilterBuilder {
    ...
    pub fn r#type(
        mut self,
        input: crate::types::GuardrailPiiEntityType,
    ) -> Self {
            ...
            r#match: self.r#match.ok_or_else(|| {
                aws_smithy_types::error::operation::BuildError::missing_field(
                    ...
                    "r#match was not specified but it is required when \
                     building GuardrailPiiEntityFilter",
                )
            })?,
