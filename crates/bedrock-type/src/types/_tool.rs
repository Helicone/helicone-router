...
impl Tool {
    ...
    /// [`CachePoint`](crate::types::Tool::CachePoint), extracting the inner
    /// [`CachePointBlock`](crate::types::CachePointBlock). Returns `Err(&
    ...
    /// [`CachePoint`](crate::types::Tool::CachePoint).
    pub fn is_cache_point(&self) -> bool {
        self.as_cache_point().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`ToolSpec`](crate::types::Tool::ToolSpec), extracting the inner
    /// [`ToolSpecification`](crate::types::ToolSpecification).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool_spec(
        &self,
    ) -> ::std::result::Result<&crate::types::ToolSpecification, &Self> {
