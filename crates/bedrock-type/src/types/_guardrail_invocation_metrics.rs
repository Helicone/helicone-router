...
pub struct GuardrailInvocationMetrics {
    /// <p>The processing latency details for the guardrail invocation
    /// metrics.</p>
...
impl GuardrailInvocationMetrics {
    ...
    pub fn usage(
        &self,
    ) -> ::std::option::Option<&crate::types::GuardrailUsage> {
        self.usage.as_ref()
    }
    /// <p>The coverage details for the guardrail invocation metrics.</p>
    pub fn guardrail_coverage(
        &self,
    ) -> ::std::option::Option<&crate::types::GuardrailCoverage> {
...
impl GuardrailInvocationMetricsBuilder {
    ...
    /// <p>The processing latency details for the guardrail invocation
    /// metrics.</p>
    pub fn set_guardrail_processing_latency(
        mut self,
    ...
    /// <p>The processing latency details for the guardrail invocation
    /// metrics.</p>
    pub fn get_guardrail_processing_latency(
        &self,
    ...
    pub fn set_usage(
        mut self,
        input: ::std::option::Option<crate::types::GuardrailUsage>,
    ) -> Self {
        self.usage = input;
        self
    }
    ...
    pub fn guardrail_coverage(
        mut self,
        input: crate::types::GuardrailCoverage,
    ) -> Self {
