...
/// <p>A video source. You can upload a smaller video as a base64-encoded string
/// as long as the encoded file is less than 25MB. You can also transfer videos
/// up to 1GB in size from an S3 bucket.</p>
#[non_exhaustive]
#[derive(
    ::std::clone::Clone,
    ::std::cmp::PartialEq,
...
impl VideoSource {
    ...
    /// [`Bytes`](crate::types::VideoSource::Bytes), extracting the inner
    /// [`Blob`](aws_smithy_types::Blob). Returns `Err(&Self)` if it can't
    /// be converted.
    pub fn as_bytes(
        &self,
    ...
    /// Tries to convert the enum instance into
    /// [`S3Location`](crate::types::VideoSource::S3Location), extracting the
    /// inner [`S3Location`](crate::types::S3Location). Returns `Err(&Self)`
    /// if it can't be converted.
    pub fn as_s3_location(
        &self,
    ) -> ::std::result::Result<&crate::types::S3Location, &Self> {
    ...
    /// [`S3Location`](crate::types::VideoSource::S3Location).
