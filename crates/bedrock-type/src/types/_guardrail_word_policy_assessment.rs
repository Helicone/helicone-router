...
pub struct GuardrailWordPolicyAssessmentBuilder {
    pub(crate) custom_words: ::std::option::Option<
        ::std::vec::Vec<crate::types::GuardrailCustomWord>,
    >,
    pub(crate) managed_word_lists: ::std::option::Option<
        ::std::vec::Vec<crate::types::GuardrailManagedWord>,
    >,
}
impl GuardrailWordPolicyAssessmentBuilder {
    ...
    /// [`set_custom_words`](Self::set_custom_words).
    ///
    /// <p>Custom words in the assessment.</p>
    pub fn custom_words(
        mut self,
        input: crate::types::GuardrailCustomWord,
    ) -> Self {
    ...
    ///
    /// To override the contents of this collection use
    /// [`set_managed_word_lists`](Self::set_managed_word_lists).
    ///
    /// <p>Managed word lists in the assessment.</p>
    pub fn managed_word_lists(
        mut self,
        input: crate::types::GuardrailManagedWord,
    ) -> Self {
        ...
        ::std::result::Result::Ok(crate::types::GuardrailWordPolicyAssessment {
            custom_words: self.custom_words.ok_or_else(|| {
                aws_smithy_types::error::operation::BuildError::missing_field(
                    "custom_words",
                    "custom_words was not specified but it is required when \
                     building GuardrailWordPolicyAssessment",
                )
            })?,
            managed_word_lists: self.managed_word_lists.ok_or_else(|| {
                aws_smithy_types::error::operation::BuildError::missing_field(
                    "managed_word_lists",
                    "managed_word_lists was not specified but it is required \
                     when building GuardrailWordPolicyAssessment",
                )
            })?,
        })
    }
