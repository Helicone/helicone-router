...
impl CachePointBlock {
    ...
    /// [`CachePointBlock`](crate::types::CachePointBlock).
...
impl CachePointBlockBuilder {
    ...
    pub fn set_type(
        mut self,
        input: ::std::option::Option<crate::types::CachePointType>,
    ) -> Self {
        self.r#type = input;
        self
    }
    ...
    pub fn get_type(
        &self,
    ) -> &::std::option::Option<crate::types::CachePointType> {
        &self.r#type
    }
    /// Consumes the builder and constructs a
    /// [`CachePointBlock`](crate::types::CachePointBlock). This method will
