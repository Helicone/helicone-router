...
pub enum ImageSource {
    /// <p>The raw image bytes for the image. If you use an AWS SDK, you don't
    /// need to encode the image bytes in base64.</p>
...
impl ImageSource {
    ...
    /// [`Bytes`](crate::types::ImageSource::Bytes), extracting the inner
    ...
    /// Tries to convert the enum instance into
    /// [`S3Location`](crate::types::ImageSource::S3Location), extracting the
    ...
    /// [`S3Location`](crate::types::ImageSource::S3Location).
