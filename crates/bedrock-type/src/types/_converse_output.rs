...
impl ConverseOutput {
    ...
    /// [`Message`](crate::types::ConverseOutput::Message), extracting the inner
    /// [`Message`](crate::types::Message). Returns `Err(&Self)` if it can't
    /// be converted.
    pub fn as_message(
        &self,
    ) -> ::std::result::Result<&crate::types::Message, &Self> {
    ...
    /// [`Message`](crate::types::ConverseOutput::Message).
