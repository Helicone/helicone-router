...
pub enum ReasoningContentBlockDelta {
    /// <p>The content in the reasoning that was encrypted by the model
    /// provider for safety reasons. The encryption doesn't affect the quality
    /// of responses.</p>
    RedactedContent(aws_smithy_types::Blob),
    /// <p>A token that verifies that the reasoning text was generated by the
    /// model. If you pass a reasoning block back to the API in a multi-turn
    /// conversation, include the text and its signature unmodified.</p>
...
impl ReasoningContentBlockDelta {
    ...
    /// extracting the inner [`Blob`](aws_smithy_types::Blob).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_redacted_content(
        &self,
    ) -> ::std::result::Result<&aws_smithy_types::Blob, &Self> {
    ...
    /// Tries to convert the enum instance into
    /// [`Signature`](crate::types::ReasoningContentBlockDelta::Signature),
    /// extracting the inner [`String`](::std::string::String).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_signature(
        &self,
    ...
    /// Tries to convert the enum instance into
    /// [`Text`](crate::types::ReasoningContentBlockDelta::Text), extracting the
    ...
    /// Returns true if this is a
    /// [`Text`](crate::types::ReasoningContentBlockDelta::Text).
