...
pub enum ToolChoice {
    ...
    /// <p>(Default). The Model automatically decides if a tool should be
    /// called or whether to generate text instead.</p>
    Auto(crate::types::AutoToolChoice),
    /// <p>The Model must request the specified tool. Only supported by
...
impl ToolChoice {
    ...
    /// [`Any`](crate::types::ToolChoice::Any), extracting the inner
    /// [`AnyToolChoice`](crate::types::AnyToolChoice). Returns `Err(&Self)`
    /// if it can't be converted.
    pub fn as_any(
        &self,
    ) -> ::std::result::Result<&crate::types::AnyToolChoice, &Self> {
    ...
    /// Tries to convert the enum instance into
    /// [`Auto`](crate::types::ToolChoice::Auto), extracting the inner
    /// [`AutoToolChoice`](crate::types::AutoToolChoice). Returns `Err(&
    /// Self)` if it can't be converted.
    pub fn as_auto(
        &self,
    ) -> ::std::result::Result<&crate::types::AutoToolChoice, &Self> {
    ...
    /// Tries to convert the enum instance into
    /// [`Tool`](crate::types::ToolChoice::Tool), extracting the inner
    /// [`SpecificToolChoice`](crate::types::SpecificToolChoice).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_tool(
        &self,
    ) -> ::std::result::Result<&crate::types::SpecificToolChoice, &Self> {
