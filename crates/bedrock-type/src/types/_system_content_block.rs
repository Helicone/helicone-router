...
impl SystemContentBlock {
    ...
    /// [`CachePoint`](crate::types::SystemContentBlock::CachePoint), extracting
    /// the inner [`CachePointBlock`](crate::types::CachePointBlock).
    ...
    /// [`CachePoint`](crate::types::SystemContentBlock::CachePoint).
    pub fn is_cache_point(&self) -> bool {
        self.as_cache_point().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`GuardContent`](crate::types::SystemContentBlock::GuardContent),
    /// extracting the inner
    /// [`GuardrailConverseContentBlock`](crate::types::GuardrailConverseContentBlock).
    /// Returns `Err(&Self)` if it can't be converted.
    ...
    /// Tries to convert the enum instance into
    /// [`Text`](crate::types::SystemContentBlock::Text), extracting the inner
    ...
    /// Returns true if this is a
    /// [`Text`](crate::types::SystemContentBlock::Text).
