...
pub enum GuardrailContentBlock {
    /// <p>Image within guardrail content block to be evaluated by the
    /// guardrail.</p>
...
impl GuardrailContentBlock {
    ...
    /// [`Image`](crate::types::GuardrailContentBlock::Image), extracting the
    /// inner [`GuardrailImageBlock`](crate::types::GuardrailImageBlock).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_image(
        &self,
    ) -> ::std::result::Result<&crate::types::GuardrailImageBlock, &Self> {
    ...
    /// [`Image`](crate::types::GuardrailContentBlock::Image).
    pub fn is_image(&self) -> bool {
        self.as_image().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`Text`](crate::types::GuardrailContentBlock::Text), extracting the
    /// inner [`GuardrailTextBlock`](crate::types::GuardrailTextBlock).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_text(
        &self,
    ) -> ::std::result::Result<&crate::types::GuardrailTextBlock, &Self> {
    ...
    /// Returns true if this is a
    /// [`Text`](crate::types::GuardrailContentBlock::Text).
...
impl ::std::fmt::Debug for GuardrailContentBlock {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            GuardrailContentBlock::Text(val) => {
