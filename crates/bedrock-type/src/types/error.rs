...
pub enum ResponseStreamError {
    ...
    /// <p>The request took too long to process. Processing time exceeded the
    /// model timeout length.</p>
    ...
    /// An unexpected error occurred (e.g., invalid JSON returned by the
    /// service or an unknown error code).
    #[deprecated(note = "Matching `Unhandled` directly is not forwards \
                         compatible. Instead, match using a variable \
                         wildcard pattern and check `.code()`:
     &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") \
                         => { /* handle the error */ }`
     See [`ProvideErrorMetadata`](#\
                         impl-ProvideErrorMetadata-for-ResponseStreamError) \
                         for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ResponseStreamError {
    /// Creates the `ResponseStreamError::Unhandled` variant from an
    ...
    /// `ResponseStreamError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is
    /// `ResponseStreamError::ModelStreamErrorException`.
    pub fn is_model_stream_error_exception(&self) -> bool {
        matches!(self, Self::ModelStreamErrorException(_))
    }
    /// Returns `true` if the error kind is
    /// `ResponseStreamError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
    /// Returns `true` if the error kind is
    /// `ResponseStreamError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is
    /// `ResponseStreamError::ModelTimeoutException`.
    pub fn is_model_timeout_exception(&self) -> bool {
        matches!(self, Self::ModelTimeoutException(_))
    }
    /// Returns `true` if the error kind is
    /// `ResponseStreamError::ServiceUnavailableException`.
...
impl aws_smithy_types::retry::ProvideErrorKind for ResponseStreamError {
    ...
    fn retryable_error_kind(
        &self,
    ) -> ::std::option::Option<aws_smithy_types::retry::ErrorKind> {
        ::std::option::Option::None
    }
}
impl aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ResponseStreamError
{
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InternalServerException(_inner) => {
                aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(
                    _inner,
                )
            }
            Self::ModelStreamErrorException(_inner) => {
...
impl aws_types::request_id::RequestId
    for crate::types::error::ResponseStreamError
{
...
/// Error type for the `InvokeModelWithBidirectionalStreamOutputError`
/// operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
...
impl InvokeModelWithBidirectionalStreamOutputError {
    /// Creates the `InvokeModelWithBidirectionalStreamOutputError::Unhandled`
    ...
    /// Returns `true` if the error kind is
    /// `InvokeModelWithBidirectionalStreamOutputError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is
    /// `InvokeModelWithBidirectionalStreamOutputError::ModelStreamErrorException`.
    pub fn is_model_stream_error_exception(&self) -> bool {
        matches!(self, Self::ModelStreamErrorException(_))
    }
    /// Returns `true` if the error kind is
    /// `InvokeModelWithBidirectionalStreamOutputError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
    /// Returns `true` if the error kind is
    /// `InvokeModelWithBidirectionalStreamOutputError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is
    /// `InvokeModelWithBidirectionalStreamOutputError::ModelTimeoutException`.
    pub fn is_model_timeout_exception(&self) -> bool {
        matches!(self, Self::ModelTimeoutException(_))
    }
    /// Returns `true` if the error kind is
    /// `InvokeModelWithBidirectionalStreamOutputError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
}
...
impl InvokeModelWithBidirectionalStreamInputError {
    /// Creates the `InvokeModelWithBidirectionalStreamInputError::Unhandled`
    /// variant from any error type.
    pub fn unhandled(
        err: impl ::std::convert::Into<
            ::std::boxed::Box<
...
pub enum ConverseStreamOutputError {
    ...
    /// service or an unknown error code).
    #[deprecated(
        note = "Matching `Unhandled` directly is not forwards compatible. \
                Instead, match using a variable wildcard pattern and check \
                `.code()`:
     &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") \
                => { /* handle the error */ }`
     See [`ProvideErrorMetadata`](#\
                impl-ProvideErrorMetadata-for-ConverseStreamOutputError) for \
                what information is available for the error."
    )]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ConverseStreamOutputError {
    /// Creates the `ConverseStreamOutputError::Unhandled` variant from any
    /// error type.
    pub fn unhandled(
        err: impl ::std::convert::Into<
            ::std::boxed::Box<
    ...
    /// Creates the `ConverseStreamOutputError::Unhandled` variant from an
    /// [`ErrorMetadata`](aws_smithy_types::error::ErrorMetadata).
    pub fn generic(err: aws_smithy_types::error::ErrorMetadata) -> Self {
        Self::Unhandled(crate::error::sealed_unhandled::Unhandled {
            source: err.clone().into(),
