...
/// <p>A text block that contains text that you want to assess with a guardrail.
/// For more information, see <code>GuardrailConverseContentBlock</code>.</p>
#[non_exhaustive]
#[derive(
    ::std::clone::Clone,
    ::std::cmp::PartialEq,
...
pub struct GuardrailConverseTextBlock {
    ...
    /// <p>The qualifier details for the guardrails contextual grounding
    /// filter.</p>
    pub qualifiers: ::std::option::Option<
...
impl GuardrailConverseTextBlock {
    ...
    /// to determine if no value was sent, use `.qualifiers.is_none()`.
    pub fn qualifiers(
        &self,
    ) -> &[crate::types::GuardrailConverseContentQualifier] {
...
pub struct GuardrailConverseTextBlockBuilder {
    ...
    pub(crate) qualifiers: ::std::option::Option<
        ::std::vec::Vec<crate::types::GuardrailConverseContentQualifier>,
    >,
}
impl GuardrailConverseTextBlockBuilder {
    ...
    /// [`set_qualifiers`](Self::set_qualifiers).
    ///
    /// <p>The qualifier details for the guardrails contextual grounding
    /// filter.</p>
    pub fn qualifiers(
        mut self,
        input: crate::types::GuardrailConverseContentQualifier,
    ) -> Self {
        ...
        ::std::result::Result::Ok(crate::types::GuardrailConverseTextBlock {
            text: self.text.ok_or_else(|| {
                aws_smithy_types::error::operation::BuildError::missing_field(
                    "text",
                    "text was not specified but it is required when building \
