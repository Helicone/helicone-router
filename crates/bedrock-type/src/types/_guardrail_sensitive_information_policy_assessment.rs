...
pub struct GuardrailSensitiveInformationPolicyAssessmentBuilder {
    pub(crate) pii_entities: ::std::option::Option<
        ::std::vec::Vec<crate::types::GuardrailPiiEntityFilter>,
    >,
    pub(crate) regexes: ::std::option::Option<
        ::std::vec::Vec<crate::types::GuardrailRegexFilter>,
    >,
}
impl GuardrailSensitiveInformationPolicyAssessmentBuilder {
    ...
    /// [`set_pii_entities`](Self::set_pii_entities).
    ///
    /// <p>The PII entities in the assessment.</p>
    pub fn pii_entities(
        mut self,
        input: crate::types::GuardrailPiiEntityFilter,
    ) -> Self {
    ...
    ///
    /// To override the contents of this collection use
    /// [`set_regexes`](Self::set_regexes).
    ///
    /// <p>The regex queries in the assessment.</p>
    pub fn regexes(
        mut self,
        input: crate::types::GuardrailRegexFilter,
    ) -> Self {
