...
impl ResponseStream {
    ...
    /// [`Chunk`](crate::types::ResponseStream::Chunk), extracting the inner
    /// [`PayloadPart`](crate::types::PayloadPart). Returns `Err(&Self)` if
    /// it can't be converted.
    pub fn as_chunk(
        &self,
    ) -> ::std::result::Result<&crate::types::PayloadPart, &Self> {
    ...
    /// [`Chunk`](crate::types::ResponseStream::Chunk).
