...
pub struct GuardrailContextualGroundingPolicyAssessment {
    /// <p>The filter details for the guardrails contextual grounding
    /// filter.</p>
...
impl GuardrailContextualGroundingPolicyAssessment {
    ...
    /// to determine if no value was sent, use `.filters.is_none()`.
    pub fn filters(
        &self,
...
impl GuardrailContextualGroundingPolicyAssessmentBuilder {
    ...
    pub fn filters(
        mut self,
        input: crate::types::GuardrailContextualGroundingFilter,
    ) -> Self {
