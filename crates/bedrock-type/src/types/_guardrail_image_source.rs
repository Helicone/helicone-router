...
/// <p>The image source (image bytes) of the guardrail image source. Object used
/// in independent api.</p>
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq)]
pub enum GuardrailImageSource {
    /// <p>The bytes details of the guardrail image source. Object used in
    /// independent api.</p>
...
impl GuardrailImageSource {
    ...
    /// [`Bytes`](crate::types::GuardrailImageSource::Bytes), extracting the
    /// inner [`Blob`](aws_smithy_types::Blob). Returns `Err(&Self)` if it
    /// can't be converted.
    pub fn as_bytes(
        &self,
    ...
    /// [`Bytes`](crate::types::GuardrailImageSource::Bytes).
