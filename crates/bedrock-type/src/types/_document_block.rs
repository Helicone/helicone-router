...
pub struct DocumentBlock {
    ...
    /// </ul><note>
    /// <p>This field is vulnerable to prompt injections, because the model
    /// might inadvertently interpret it as instructions. Therefore, we
    /// recommend that you specify a neutral name.</p> </note>
...
impl DocumentBlock {
    ...
    pub fn source(
        &self,
    ) -> ::std::option::Option<&crate::types::DocumentSource> {
        self.source.as_ref()
    }
}
impl DocumentBlock {
...
impl DocumentBlockBuilder {
    ...
    pub fn get_format(
        &self,
    ) -> &::std::option::Option<crate::types::DocumentFormat> {
        &self.format
    }
    /// <p>A name for the document. The name can only contain the following
    /// characters:</p> <ul>
    ...
    /// [`DocumentBlock`](crate::types::DocumentBlock). This method will
