...
pub struct GuardrailConverseImageBlock {
    /// <p>The format details for the image type of the guardrail converse
    /// image block.</p>
    pub format: crate::types::GuardrailConverseImageFormat,
    /// <p>The image source (image bytes) of the guardrail converse image
    /// block.</p>
    pub source:
        ::std::option::Option<crate::types::GuardrailConverseImageSource>,
}
...
pub struct GuardrailConverseImageBlockBuilder {
    pub(crate) format:
        ::std::option::Option<crate::types::GuardrailConverseImageFormat>,
    pub(crate) source:
        ::std::option::Option<crate::types::GuardrailConverseImageSource>,
}
impl GuardrailConverseImageBlockBuilder {
    /// <p>The format details for the image type of the guardrail converse image
    /// block.</p> This field is required.
    pub fn format(
        mut self,
        input: crate::types::GuardrailConverseImageFormat,
    ) -> Self {
    ...
    pub fn set_format(
        ...
        input: ::std::option::Option<
            crate::types::GuardrailConverseImageFormat,
        >,
    ) -> Self {
        self.format = input;
        self
    ...
    pub fn set_source(
        mut self,
        input: ::std::option::Option<
            crate::types::GuardrailConverseImageSource,
        >,
    ) -> Self {
        self.source = input;
        self
            ...
            format: self.format.ok_or_else(|| {
                aws_smithy_types::error::operation::BuildError::missing_field(
                    ...
                    "format was not specified but it is required when \
                     building GuardrailConverseImageBlock",
                )
            })?,
            source: self.source,
        })
...
impl ::std::fmt::Debug for GuardrailConverseImageBlockBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter =
            f.debug_struct("GuardrailConverseImageBlockBuilder");
        formatter.field("format", &"*** Sensitive Data Redacted ***");
        formatter.field("source", &"*** Sensitive Data Redacted ***");
        formatter.finish()
    }
