...
pub enum DocumentSource {
    /// <p>The raw bytes for the document. If you use an Amazon Web Services
    /// SDK, you don't need to encode the bytes in base64.</p>
...
impl DocumentSource {
    ...
    /// [`Bytes`](crate::types::DocumentSource::Bytes), extracting the inner
    ...
    /// [`Bytes`](crate::types::DocumentSource::Bytes).
    pub fn is_bytes(&self) -> bool {
        self.as_bytes().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`S3Location`](crate::types::DocumentSource::S3Location), extracting the
    ...
    /// Returns true if this is a
    /// [`S3Location`](crate::types::DocumentSource::S3Location).
