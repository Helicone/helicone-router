...
impl ToolResultContentBlock {
    ...
    /// [`Document`](crate::types::ToolResultContentBlock::Document), extracting
    /// the inner [`DocumentBlock`](crate::types::DocumentBlock).
    ...
    /// [`Document`](crate::types::ToolResultContentBlock::Document).
    pub fn is_document(&self) -> bool {
        self.as_document().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`Image`](crate::types::ToolResultContentBlock::Image), extracting the
    /// inner [`ImageBlock`](crate::types::ImageBlock). Returns `Err(&Self)`
    ...
    /// Returns true if this is a
    /// [`Image`](crate::types::ToolResultContentBlock::Image).
    pub fn is_image(&self) -> bool {
        self.as_image().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`Json`](crate::types::ToolResultContentBlock::Json), extracting the
    /// inner [`Document`](aws_smithy_types::Document). Returns `Err(&Self)`
    /// if it can't be converted.
    pub fn as_json(
        &self,
    ) -> ::std::result::Result<&aws_smithy_types::Document, &Self> {
    ...
    /// Returns true if this is a
    /// [`Json`](crate::types::ToolResultContentBlock::Json).
    pub fn is_json(&self) -> bool {
        self.as_json().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`Text`](crate::types::ToolResultContentBlock::Text), extracting the
    /// inner [`String`](::std::string::String). Returns `Err(&Self)` if it
    /// can't be converted.
    pub fn as_text(
        &self,
    ...
    /// Returns true if this is a
    /// [`Text`](crate::types::ToolResultContentBlock::Text).
    pub fn is_text(&self) -> bool {
        self.as_text().is_ok()
    }
    /// Tries to convert the enum instance into
    /// [`Video`](crate::types::ToolResultContentBlock::Video), extracting the
    /// inner [`VideoBlock`](crate::types::VideoBlock). Returns `Err(&Self)`
    /// if it can't be converted.
    pub fn as_video(
        &self,
    ...
    /// Returns true if this is a
    /// [`Video`](crate::types::ToolResultContentBlock::Video).
