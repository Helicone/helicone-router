...
pub struct GuardrailCoverage {
    ...
    /// <p>The guardrail coverage for images (the number of images that
    /// guardrails guarded).</p>
...
impl GuardrailCoverage {
    ...
    pub fn images(
        &self,
    ) -> ::std::option::Option<&crate::types::GuardrailImageCoverage> {
        self.images.as_ref()
    }
}
impl GuardrailCoverage {
    /// Creates a new builder-style object to manufacture
    /// [`GuardrailCoverage`](crate::types::GuardrailCoverage).
...
impl GuardrailCoverageBuilder {
    ...
    pub fn text_characters(
        mut self,
        input: crate::types::GuardrailTextCharactersCoverage,
    ) -> Self {
    ...
    pub fn images(
        mut self,
        input: crate::types::GuardrailImageCoverage,
    ) -> Self {
