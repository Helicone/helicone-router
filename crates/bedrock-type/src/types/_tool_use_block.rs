...
/// <p>A tool use content block. Contains information about a tool that the
...
impl ToolUseBlock {
    ...
    /// [`ToolUseBlock`](crate::types::ToolUseBlock).
...
impl ToolUseBlockBuilder {
    ...
    /// [`ToolUseBlock`](crate::types::ToolUseBlock). This method will fail
    ...
    > {
        ::std::result::Result::Ok(crate::types::ToolUseBlock {
            ...
            input: self.input.ok_or_else(|| {
                aws_smithy_types::error::operation::BuildError::missing_field(
                    "input",
                    "input was not specified but it is required when building \
                     ToolUseBlock",
                )
            })?,
        })
