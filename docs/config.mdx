...
Set the `HELICONE_CONTROL_PLANE_API_KEY` environment variable with your Helicone API key.

[Learn more](/ai-gateway/features/helicone-integration)

<ParamField path="helicone-observability.enable-auth" type="boolean" default="false">
...
<ParamField path="helicone-observability.websocket-url" type="string" default="wss://api.helicone.ai/ws/v1/router/control-plane">
